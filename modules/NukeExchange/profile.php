...
<body>
    ...
    <h1>nuke_users Profile</h1>
        ...
        <input type = "user_email" name="" placeholder="javascript,java,c#,php,....">
    ...
    <?php
      foreach($questions as &$question) {
          echo "<a class='question' href='nuke_answer.php?user_id={$question['user_id']}'>".$question['title']."</a>";
      }
    ?>
    ...
    <?php
      foreach($answers as &$answer) {
          echo "<a class='question' href='nuke_answer.php?user_id={$question['user_id']}'>".$answer['title']."</a>";
      }
    ?>
