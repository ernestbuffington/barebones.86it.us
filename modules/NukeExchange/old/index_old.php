...
<a href="report.php?user_id=Q12">
<div class="card border-primary mb-3" style="max-width: 18rem;">
  <div class="card-header">Report 1</div>
  <div class="card-body text-primary">
    <h5 class="card-title">nuke_question 12</h5>
    <p class="card-text">Get details of all the people who got vaccinated only one dose and are of
      group ages 1 to 3 (first-name, last-name, date of birth, user_email, phone, city, date of
      vaccination, vaccination type, been infected by COVID-19 before or not).</p>
  </div>
</div>
</a>

<a href="report.php?user_id=Q13">
<div class="card border-secondary mb-3" style="max-width: 18rem;">
  <div class="card-header">Report 2</div>
  <div class="card-body text-secondary">
    <h5 class="card-title">nuke_question 13</h5>
    <p class="card-text">Get details of all the people who live in the city of Montréal and who got
      vaccinated at least two doses of different types of vaccines. (First-name, lastname, date of birth, user_email, phone, city, date of vaccination, vaccination type, been
      infected by COVID-19 before or not).</p>
  </div>
</div>
</a>

<a href="report.php?user_id=Q14">
<div class="card border-secondary mb-3" style="max-width: 18rem;">
  <div class="card-header">Report 3</div>
  <div class="card-body text-secondary">
    <h5 class="card-title">nuke_question 14</h5>
    <p class="card-text">Get details of all the people who got vaccinated and have been infected with at
      ...
      user_email, phone, city, date of vaccination, vaccination type, number of times being
      infected by COVID-19 variants)</p>
  </div>
</div>
</a>

<a href="report.php?user_id=Q15">
<div class="card border-secondary mb-3" style="max-width: 18rem;">
  <div class="card-header">Report 4</div>
  <div class="card-body text-secondary">
    <h5 class="card-title">nuke_question 15</h5>
...
<a href="report.php?user_id=Q16">
<div class="card border-secondary mb-3" style="max-width: 18rem;">
  <div class="card-header">Report 5</div>
  <div class="card-body text-secondary">
    <h5 class="card-title">nuke_question 16</h5>
...
<a href="report.php?user_id=Q17">
<div class="card border-secondary mb-3" style="max-width: 18rem;">
  <div class="card-header">Report 6</div>
  <div class="card-body text-secondary">
    <h5 class="card-title">nuke_question 17</h5>
...
<a href="report.php?user_id=Q18">
<div class="card border-secondary mb-3" style="max-width: 18rem;">
  <div class="card-header">Report 7</div>
  <div class="card-body text-secondary">
    <h5 class="card-title">nuke_question 18</h5>
...
<a href="report.php?user_id=Q19">
<div class="card border-secondary mb-3" style="max-width: 18rem;">
  <div class="card-header">Report 8</div>
  <div class="card-body text-secondary">
    <h5 class="card-title">nuke_question 19</h5>
...
number, telephone-number, address, city, province, postal-code, citizenship, user_email
address, and history of employment).</p>
  </div>
</div>
</a>

<a href="report.php?user_id=Q20">
<div class="card border-secondary mb-3" style="max-width: 18rem;">
  <div class="card-header">Report 9</div>
  <div class="card-body text-secondary">
    <h5 class="card-title">nuke_question 20</h5>
    <p class="card-text">Give a list of all public health workers in Québec who never been vaccinated
or who have been vaccinated only one dose for Covid-19 (EmployeeID, firstname, last-name, date of birth, telephone-number, city, user_email address, locations
