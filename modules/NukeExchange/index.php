...
<body>
    ...
    <div class="container">
        ...
        <!-- <a class="question" href="nuke_answer.php">How do I program?</a>
        ...
        <a href="addquestion.php" <button type="button" class="btn btn-outline-primary btn-sm">Ask nuke_question</button> </a>
        ...
        $(document).ready(function () {
         ...
         function  onDataReceived(data) {
              ...
              for (const element of data) {
                ...
                $(".container").append(`<a class='question' href='nuke_answer.php?user_id=${element.user_id}'>
                                            <div class='row'>
                                                <div class='col-2'>
    ...
    <div id="main-container" class="container">
        ...
        <script>
            ...
            for (let i = 0; i < questions.length; i++) {
                ...
                var link = "nuke_answer.php?user_id="+i;
        ...
        <br>
        <br>
        <!--<button type="button" class="btn btn-outline-primary btn-sm">Ask nuke_question</button>-->
