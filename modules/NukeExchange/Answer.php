...
<body>
<link rel="stylesheet" href="css/nuke_answer.css">
<br>
<div class="main">
...
<div class="main">
    <div id="answer-box-container">
        <p id="answer-box-name">Your nuke_answer</p>
        ...
        <button type="button" style="width:100%" onclick="nuke_answer()">Submit</button>
    ...
    <div id="answers-container">
        ...
        <table border="0" width="100%" id="question-pane">
            ...
            <?php foreach($answers as &$answer) { ?>
                ...
                <tr>
                    <td style="text-align: center">
                        <button type="button" class="upvote <?php echo ($answer["vote"] == 1 ? "upvote-voted": "") ?>" onclick="upvote(<?=$answer["user_id"] ?>,'answers/vote', this)">▲</button>
                    </td>
                ...
                <tr>
                    <td style="text-align: center">
                        <button type="button" class="downvote <?php echo ($answer["vote"] == -1 ? "downvote-voted": "") ?>" onclick="downvote(<?=$answer["user_id"] ?>,'answers/vote', this)">▼</button>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center">
                        <button type="button" onclick="best(<?=$answer["user_id"] ?>,<?=$id ?>, this)" class="btn <?php echo ($answer["isAccepted"] == 1 ? "best btn-success": "") ?>" onclick="less_q(this)">&#x2714;</button>
                    </td>
                </tr>
            <?php } ?>
        </table>
        ...
        <script type="text/javascript">
            function nuke_answer() {
                if(document.getElementById('answer-box').value == "") {
                    alert("nuke_answer Box empty! Please write an answer before submitting.");
                } else {
            ...
            function  onDataReceived(data) {
              if(data.RESULT == 1) {
                ...
                redirectUser(`nuke_answer.php?user_id=<?=$id?>`,3000);
              } else {
