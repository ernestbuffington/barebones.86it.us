...
<body>
     ...
     <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarColor02" aria-controls="navbarColor02" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse" id="navbarColor02">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item"> <a class="nav-link" href="addquestion.php" data-abc="true">Ask a nuke_question</a> </li>
                <li class="nav-item"> <a class="nav-link" href="profile.php" data-abc="true">Check nuke_users Profile</a> </li>
            </ul>
    ...
    <a href="addquestion.php">Ask a nuke_question</a>
    <a href="profile.php">Check nuke_users Profile</a>
