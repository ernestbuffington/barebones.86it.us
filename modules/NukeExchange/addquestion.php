...
<body>
    <div class = "container">
        <div class = "main">
            ...
            <form action="questions/add" id="validQuestion">
                <div id="Title-container">
                    ...
                    <div class="alert alert-danger hide" role="alert" id="alert-danger">
                        ...
                        <textarea id="title-box" name="title" class="box" rows="1" cols="101" form="send-form" placeholder="e.g. is there an R function for finding the index of an element in a vector?" required></textarea>
                    </div>

                <div id="nuke_question-box-container">
                        <p id = "Body-name">Body</p>
                        <p id = "body-description">Include all the information someone would need to answer your question</p>
                        <textarea name="question" id="question-box" class="question-box" rows="10" cols="101" form="send-form" required></textarea>
                </div>
            ...
            <button  class="btn btn-outline-primary btn-sm" onclick='submitForm("validQuestion", "onDataReceived")'>Post nuke_question</button>
    ...
    <script>
      ...
      function  onDataReceived(data) {
          if(data.RESULT == 1) {
            ...
            redirectUser(`nuke_answer.php?user_id=${data.user_id}`,3000);
          } else {
      ...
      function  onDataReceivedTag(data) {
        ...
        for (const element of data) {
          $("#tags").append(`<option  value='${element.id}'>${element.name}</option>`)
        }
      }
  </script>
</body>
